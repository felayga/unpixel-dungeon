...
public class Terrain {
	...
	public static final int DIRT_TILES			= 64;
	public static final int DIRT				= 79;

	public static final int WATER_DEEP_TILES	= 80;
	public static final int WATER_DEEP			= 95;

	public static final int DIRT_DEEP_TILES		= 96;
	public static final int DIRT_DEEP			= 111;
	...
	static {
		flags[CHASM] = FLAG_AVOID | FLAG_PIT | FLAG_UNSTITCHABLE;
		flags[EMPTY] = FLAG_PASSABLE;
		flags[GRASS] = FLAG_PASSABLE | FLAG_WOOD;
		flags[EMPTY_WELL] = FLAG_PASSABLE | FLAG_STONE;
		flags[WATER] = FLAG_PASSABLE | FLAG_LIQUID | FLAG_UNSTITCHABLE;
		...
		flags[ENTRANCE] = FLAG_PASSABLE;
		flags[EXIT] = FLAG_PASSABLE;
		flags[EMBERS] = FLAG_PASSABLE;
		flags[LOCKED_DOOR] = FLAG_LOSBLOCKING | FLAG_SOLID | FLAG_WOOD | FLAG_UNSTITCHABLE;
		flags[PEDESTAL] = FLAG_PASSABLE | FLAG_UNSTITCHABLE;
		...
		flags[EMPTY_SP] = FLAG_PASSABLE | FLAG_UNSTITCHABLE;
		flags[HIGH_GRASS] = FLAG_PASSABLE | FLAG_LOSBLOCKING | FLAG_WOOD;
		...
		flags[TRAP] = FLAG_PASSABLE | FLAG_AVOID;
		flags[INACTIVE_TRAP] = FLAG_PASSABLE;

		flags[EMPTY_DECO] = FLAG_PASSABLE;
		flags[LOCKED_EXIT] = FLAG_SOLID;
		flags[UNLOCKED_EXIT] = FLAG_PASSABLE;
		flags[SIGN] = FLAG_PASSABLE | FLAG_WOOD;
		flags[WELL] = FLAG_AVOID | FLAG_STONE;
		flags[STATUE] = FLAG_SOLID | FLAG_STONE;
		flags[STATUE_SP] = FLAG_SOLID | FLAG_STONE | FLAG_UNSTITCHABLE;
		flags[BOOKSHELF] = FLAG_WOOD | FLAG_SOLID | FLAG_LOSBLOCKING | FLAG_UNSTITCHABLE;
		flags[ALCHEMY] = FLAG_PASSABLE;
		...
		flags[WOOD_DEBRIS] = flags[OPEN_DOOR];
