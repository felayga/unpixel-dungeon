 ...
 */
package com.felayga.unpixeldungeon.windows.start;
...
public class WndHeroInit extends Window {
    ...
    public WndHeroInit(final Listener listener) {
        super();
