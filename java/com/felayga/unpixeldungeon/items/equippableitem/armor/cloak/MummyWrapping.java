 ...
 */
public class MummyWrapping extends Cloak {
    public MummyWrapping() {
        super(0, 1, GameTime.TICK);

        name = "mummy wrapping";
        image = ItemSpriteSheet.CLOAK_MUMMY;
        material = Material.Cloth;
        spriteTextureIndex = HeroSprite.ArmorIndex.CloakMummyWrapping;

        price = 2;
        weight(Encumbrance.UNIT * 3);
    }

    //todo: invisibility override
