...
import com.felayga.unpixeldungeon.items.equippableitem.armor.cloak.Cloak;
    ...
    public void syncRandomizedProperties() {
        ...
        switch(image) {
            case ItemSpriteSheet.CLOAK_PLAIN:
                spriteTextureIndex = HeroSprite.ArmorIndex.CloakPlain;
                break;
            case ItemSpriteSheet.CLOAK_OPERA:
                spriteTextureIndex = HeroSprite.ArmorIndex.CloakOpera;
                break;
            case ItemSpriteSheet.CLOAK_FANCY:
                spriteTextureIndex = HeroSprite.ArmorIndex.CloakOpera;
                break;
            case ItemSpriteSheet.CLOAK_TATTERED:
                spriteTextureIndex = HeroSprite.ArmorIndex.CloakTattered;
                break;
            default:
                spriteTextureIndex = HeroSprite.ArmorIndex.CloakNone;
                break;
        }
    }
