 ...
 *
 */
package com.felayga.unpixeldungeon.items.equippableitem.armor;
...
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Affection;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.AntiEntropy;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Bounce;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Displacement;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Entanglement;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Metabolism;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Multiplicity;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Potential;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Stench;
import com.felayga.unpixeldungeon.items.equippableitem.armor.glyphs.Viscosity;
...
public class Armor extends EquippableItem {
	...
	public int price;
	public HeroSprite.ArmorIndex spriteTextureIndex;
	...
	public Armor(int armor, int armorBonusMaximum, int armorMagic, long speedModifier, long equipTime, int spellFailure) {
        ...
        spriteTextureIndex = HeroSprite.ArmorIndex.Naked;
	}
	...
	protected void setHeroSpriteArmor(HeroSprite heroSprite, boolean equip) {
		...
		if (equip) {
			...
			heroSprite.setArmor(HeroSprite.ArmorIndex.Naked);
		}
	}
