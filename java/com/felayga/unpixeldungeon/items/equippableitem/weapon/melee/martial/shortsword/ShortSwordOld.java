...
package com.felayga.unpixeldungeon.items.equippableitem.weapon.melee.martial.shortsword;
...
import com.felayga.unpixeldungeon.items.equippableitem.weapon.melee.martial.MartialMeleeWeapon;
...
public class ShortSwordOld extends MartialMeleeWeapon {
    ...
    private final WndBackpack.Listener itemSelector = new WndBackpack.Listener() {
        ...
        public void onSelect(Item item) {
            if (item != null && !(item instanceof Boomerang)) {
                ...
                if (equipped) {
                    curUser.belongings.collectEquip(ShortSwordOld.this);
                } else {
                    curUser.belongings.collect(ShortSwordOld.this);
                }
            }
        }
    };
