...
public class PotionOfPurity extends Potion {
    ...
    private static final String TXT_NO_SMELL = "You've stopped breathing!";
    ...
    public void apply(Char hero) {
        GLog.w(TXT_NO_SMELL);
        Buff.prolong(hero, hero, GasesImmunity.class, GasesImmunity.DURATION);
        setKnown();
    }
    ...
    public String desc() {
        return
                "This reagent will quickly neutralize all harmful gases in the area of effect. " +
                        "Drinking it will temporarily suspend the need to breathe.";
    }
