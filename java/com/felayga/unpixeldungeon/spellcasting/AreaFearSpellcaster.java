...
/**
 * Created by HELLO on 3/12/2017.
 */

public class AreaFearSpellcaster extends FearSpellcaster {
    public AreaFearSpellcaster() {
        super("Fear", 3);
    ...
    public void onZap(Char source, Ballistica path, int targetPos) {
        ...
        for (int n = 0; n < chars.size(); n++) {
            ...
            if (spots.contains(pos) && Level.fieldOfView[pos]) {
