...
public class ItemSpriteSheet {
	...
	//Row Eleven: Potions
	public static final int POTION_RUBY			= ROW11+0;
	public static final int POTION_PINK			= ROW11+1;
	public static final int POTION_ORANGE		= ROW11+2;
	public static final int POTION_YELLOW		= ROW11+3;
	public static final int POTION_EMERALD		= ROW11+4;
	public static final int POTION_DARKGREEN	= ROW11+5;
	public static final int POTION_CYAN			= ROW11+6;
	public static final int POTION_SKYBLUE		= ROW11+7;
	public static final int POTION_BRILLIANTBLUE= ROW11+8;
	public static final int POTION_MAGENTA		= ROW11+9;
	public static final int POTION_PURPLERED	= ROW11+10;
	public static final int POTION_PUCE			= ROW11+11;
	public static final int POTION_MILKY		= ROW11+12;
	public static final int POTION_SWIRLY		= ROW11+13;
	public static final int POTION_BUBBLY		= ROW11+14;
	public static final int POTION_SMOKY		= ROW11+15;
	public static final int POTION_CLOUDY		= ROW12+0;
	public static final int POTION_EFFERVESCENT	= ROW12+1;
	public static final int POTION_BLACK		= ROW12+2;
	public static final int POTION_GOLDEN		= ROW12+3;
	public static final int POTION_BROWN		= ROW12+4;
	public static final int POTION_FIZZY		= ROW12+5;
	public static final int POTION_DARK			= ROW12+6;
	public static final int POTION_WHITE		= ROW12+7;
	public static final int POTION_MURKY		= ROW12+8;
	public static final int POTION_CLEAR		= ROW12+9;

	//Row Twelve: Seeds
	public static final int SEED_ROTBERRY	= ROW13+0;
	public static final int SEED_FIREBLOOM	= ROW13+1;
	public static final int SEED_STARFLOWER	= ROW13+2;
	public static final int SEED_BLINDWEED	= ROW13+3;
	public static final int SEED_SUNGRASS	= ROW13+4;
	public static final int SEED_ICECAP		= ROW13+5;
	public static final int SEED_STORMVINE	= ROW13+6;
	public static final int SEED_SORROWMOSS	= ROW13+7;
	public static final int SEED_DREAMFOIL	= ROW13+8;
	public static final int SEED_EARTHROOT	= ROW13+9;
	public static final int SEED_FADELEAF	= ROW13+10;
	public static final int SEED_BLANDFRUIT	= ROW13+11;

	//Row Thirteen: Food
	public static final int MEAT		= ROW14+0;
	public static final int STEAK		= ROW14+1;
	public static final int OVERPRICED	= ROW14+2;
	public static final int CARPACCIO	= ROW14+3;
	public static final int BLANDFRUIT	= ROW14+4;
	public static final int RATION		= ROW14+5;
	public static final int PASTY		= ROW14+6;

	//Row Fourteen: Quest Items
	public static final int SKULL	= ROW15+0;
	public static final int DUST	= ROW15+1;
	public static final int CANDLE	= ROW15+2;
	public static final int EMBER	= ROW15+3;
	public static final int PICKAXE	= ROW15+4;
	public static final int ORE		= ROW15+5;
	public static final int TOKEN	= ROW15+6;

	//Row Fifteen: Containers/Bags
	public static final int VIAL	    = ROW16+0;
	public static final int POUCH	    = ROW16+1;
	public static final int HOLDER	    = ROW16+2;
	public static final int BANDOLIER   = ROW16+3;
	public static final int HOLSTER	    = ROW16+4;
