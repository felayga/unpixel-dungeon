 ...
 *
 */
package com.felayga.unpixeldungeon.sprites.mobs.monkey;

import com.felayga.unpixeldungeon.Assets;
import com.felayga.unpixeldungeon.sprites.mobs.MobSprite;
import com.watabou.noosa.TextureFilm;

public class ApeSprite extends MobSprite {
    private static int FRAMES_PER_ROW = 16;

    public ApeSprite() { this(0); }

    public ApeSprite(int index) {
        super();

        texture(Assets.Mobs.MONKEY);
